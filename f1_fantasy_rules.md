...
> [!IMPORTANT]
> **关于超车次数（Overtakes）与今日最佳车手（DOTD）的规则调整**：
> 由于 FastF1 API Results 表中不直接提供官方的“净超车次数统计”与“今日最佳车手投票结果”，为了确保数据的纯粹性与本地结算的严密性，**本游戏积分规则中不包含“超车加分”与“今日最佳车手加分”**。
...
> [!WARNING]
> 车手获得的“最快圈速”额外 10 分属于个人荣誉，**不会**计入车队积分。
